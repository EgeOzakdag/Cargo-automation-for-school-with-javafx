...
public class UserWhereCargoController {
	...
	public UserWhereCargoController() {
    ...
    @FXML
    void RefreshBtn_Click(MouseEvent event) {
    ...
    public void Setup(TableView<CargoTable> CargoStatusTable) {
		...
		SqlExpression = "SELECT * FROM cargo_table WHERE SenderIdentificationNumber=?";
		...
		try {
			...
			Expression.setInt(1, UserSignedInHelper.Identification);
